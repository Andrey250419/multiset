 ...
 *
 * @param <E> the type of elements in this map
 */
public interface MultiSet<E> extends Collection<E> {

    /**
     * Returns the number of elements in this map, including all duplicates
     *
     * @return the number of elements in this map, including all duplicates
     */
    @Override
    int size();
     ...
     * Elements that occur multiple times in the map will be returned multiple times
     * by this iterator, but the order is not defined.
     *
     * @return an <tt>Iterator</tt> over the elements in this map
     */
    @Override
    Iterator<E> iterator();
    ...
    /**
     * Adds a single occurrence of the specified element to this map.
     *
     * Always returns <code>true</code>, because map always allows adding
    ...
    /**
     * Adds multiple occurrences of the specified element to this map.
     *
     * @param e  element to add
    ...
    /**
     * Removes a single occurrence of the specified element from this map, if present.
     *
    ...
    /**
     * Removes multiple occurrences of the specified element from this map, if present.
     * If map contains fewer copies of the element than given by <code>occurrences</code>
    ...
    /**
     * Returns the number of occurrences of an element in this map,
     * or <code>0</code> if map does not contain this element.
     *
     * @param e  the element to whose occurrences are to be returned
     * @return the number of occurrences of an element in this map
     */
    int count(Object e);


    /**
     * Returns <code>true</code> if this map contains at least one occurrence of each element
     ...
     * and this map contains only one.
     *
     * @param c  the collection of elements to be looked up in this map
     * @return <code>true</code> if this map contains at least one occurrence of each element in <code>c</code>
     *
     */
    @Override
    ...
    /**
     * Returns an array containing all of the elements in this map including all duplicates.
     *
     ...
     * of the element from this map, if present.
     *
     * @param c  collection with elements to remove from this map
     ...
     * of the element from this map, if present.
     *
     * @param c  collection with elements to retain in this map
     ...
     * @return <code>true</code> if this map is equal to given object as defined above
     */
    @Override
